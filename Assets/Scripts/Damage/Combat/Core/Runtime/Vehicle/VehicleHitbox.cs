// Assets/Combat/Runtime/VehicleHitbox.cs
using UnityEngine;

[DisallowMultipleComponent]
[RequireComponent(typeof(Collider))]
public sealed class VehicleHitbox : MonoBehaviour
{
	[Header("До якої секції корпусу належить цей хитбокс")]
	public VehicleSection section = VehicleSection.HullSide;
	...
	private void OnDrawGizmosSelected()
	{
		...
		{
			VehicleSection.HullFront => new Color(0.2f, 0.8f, 1f, 0.25f),
			VehicleSection.HullRear => new Color(1f, 0.4f, 0.8f, 0.25f),
			VehicleSection.HullSide => new Color(0.9f, 0.9f, 0.2f, 0.25f),
			VehicleSection.HullTop => new Color(0.6f, 1f, 0.6f, 0.25f),
		...
		else if (c is CapsuleCollider cc)
		{
			...
			Vector3 axis = cc.direction switch
			{
				0 => Vector3.right,
				1 => Vector3.up,
				_ => Vector3.forward
